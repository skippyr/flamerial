...
{
    gsettings set \
    org.gnome.Terminal.Legacy.Profile:/org/gnome/terminal/legacy/profiles:/:${g_profileUUID}/ ${1} \
    ${2};
}
...
applyProperty palette [\"#24130e\",\"#b8150d\",\"#a1650b\",\"#db7a00\",\"#c48d49\",\"#9e4711\",\
\"#948141\",\"#e8cf89\",\"#c48d49\",\"#b8150d\",\"#a1650b\",\"#db7a00\",\"#c48d49\",\"#9e4711\",\
\"#948141\",\"#e8cf89\"];
